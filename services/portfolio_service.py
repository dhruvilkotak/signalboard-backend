...
STRATEGIES: dict[str, dict] = {
    "aggressive": {
        ...
        "description":       "100% high-beta equities, HIGH confidence only. 20% per position — up to 5 positions. TSLA/PLTR/HOOD target 15-25% returns.",
        "risk_level":        "HIGH",
        "position_pct":      0.20,
        "min_confidence":    "HIGH",
    ...
    "balanced": {
        ...
        "description":       "Mix of growth ETFs + tech + income. 12% per position — full 7 stock universe coverage. 10% cash reserve.",
        "risk_level":        "MEDIUM",
        "position_pct":      0.12,
        "min_confidence":    "HIGH",
        ...
        "stop_loss_min":     3.0,
        "stop_loss_max":     7.0,
        "universe":          ["SPY","QQQ","SCHD","MSFT","AAPL","NVDA","JEPI"],
        "cash_reserve_pct":  0.10,
    },
    "tech_heavy": {
        "label":             "Tech Heavy",
        "description":       "Pure technology concentration. 14% per position — covers full 7 stock universe. AMD added for semiconductor coverage.",
        "risk_level":        "HIGH",
        "position_pct":      0.14,
        "min_confidence":    "HIGH",
    ...
    "income": {
        ...
        "description":       "Dividend ETFs + Realty Income REIT. 20% per position — 4 positions. SGOV safety anchor. Targets 3-6% steady returns.",
        "risk_level":        "LOW",
        "position_pct":      0.20,
        "min_confidence":    "HIGH",
        ...
        "stop_loss_min":     2.0,
        "stop_loss_max":     6.0,
        "universe":          ["JEPI","O","SCHD","VOO","SGOV"],
        "cash_reserve_pct":  0.10,
    },
    "conservative": {
        "label":             "Conservative",
        "description":       "Capital preservation first. 16% per position — full 5 stock universe. 20% permanent cash reserve. Targets 2-4% returns.",
        "risk_level":        "LOW",
        "position_pct":      0.16,
        "min_confidence":    "HIGH",
